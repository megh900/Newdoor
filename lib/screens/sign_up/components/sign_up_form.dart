...
class _SignUpFormState extends State<SignUpForm> {
  String gender = 'male', dob = '', fName = '', lName = '', contact = '', email = '', password = '', userType = '', address = '';
  ...
  Future _selectDate() async {
    ...
    if (pickedDate!=null){
      setState(() {
        dob = '${pickedDate.day.toString().padLeft(2, '0')}/${pickedDate.month.toString().padLeft(2, '0')}/${pickedDate.year}';
  ...
  buildPasswordFormField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        helperText: 'should be contain at least one upper, lower, digit and special character',
        floatingLabelBehavior: FloatingLabelBehavior.auto,
